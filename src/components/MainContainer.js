...
const MainContainer = () => {
    return (
        <div className="  bg-black pb-4 text-white text-center h-full">
            <div>
                <button className="font-bold border my-4 mx-2 px-4 py-2 rounded-lg bg-opacity-50 bg-slate-400"><NavLink to='/'>Home</NavLink></button>
                ...
                <button className="font-bold border my-4 mx-2 px-4 py-2 rounded-lg bg-opacity-50 bg-slate-400"><NavLink to='/formvalidation'>From Validation</NavLink></button>
            </div>
